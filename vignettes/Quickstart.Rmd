...
### Choose whether to run the CONIFEROUS (=1) or DECIDUOUS (=2) forest type 
...
### initialise the weather input data
...
```{r}
  output      <- run_model()
```
## create plot of the model output
